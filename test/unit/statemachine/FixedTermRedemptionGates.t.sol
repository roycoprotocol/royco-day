...
/**
 * @title FixedTermRedemptionGatesTest
 ...
 */
contract FixedTermRedemptionGatesTest is TrancheFixture {
    ...
    /// @dev A covered -20% senior drawdown: covUtil = ceil(104e18 x 0.2 / 4e18) = 5.2e18, above WAD and below the
