...
import { cellG } from "../../base/fixtures/TokenConfigs.sol";
import { TrancheFixture } from "../../base/fixtures/TrancheFixture.sol";
import { MockERC20C } from "../../mocks/MockERC20C.sol";

/**
 * @title CellGFeeOnTransferNightlyCells
 * @notice EXPECTED-FAILURE cell: a fee-on-transfer ST/JT vault underlying (10bps burned in transit) breaks the
 *         vault's balance-vs-accounting identity on the very first deposit, so the full smoke battery is
 *         deliberately NOT instantiated for this cell — this dedicated test pins the exact broken invariant and
 ...
 */
contract CellGFeeOnTransferNightlyCells is TrancheFixture {
