...
/**
 * @title ConstructionBoundariesTest
 ...
 */
contract ConstructionBoundariesTest is TrancheFixture {
...
/**
 * @title PreGenesisLiquidityQuoterTest
 ...
 */
contract PreGenesisLiquidityQuoterTest is TrancheFixture {
    function setUp() public {
        _deployMarket(cellA(), defaultParams());
    }
