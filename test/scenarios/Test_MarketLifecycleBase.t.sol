...
abstract contract Test_MarketLifecycleBase is DayMarketTestBase {
    ...
    /// @dev The virtual-shares/assets offset (Constants.sol VIRTUAL_SHARES / VIRTUAL_ASSETS, the OZ ERC4626
    ...
    function test_Redemptions_eachTranchePaysExactPreviewedClaims() public {
        ...
        uint256 expectedLtAssets;
        {
            ...
            uint256 rateAfter =
                Math.mulDiv(POST_SYNC_ST_EFF_NAV - (101e18 - stRawAfter) + VIRTUAL_ASSETS, 1e18, (POST_SYNC_ST_SUPPLY - 10e18) + VIRTUAL_SHARES);
    ...
    function test_STDeposit_previewMatchesExecutionExactly() public {
        ...
        uint256 expectedMinted = Math.mulDiv(100e18 + VIRTUAL_SHARES, 5e18, 100e18 + VIRTUAL_ASSETS);
    ...
    function test_STDeposit_frontRunningGainSync_capturesNoYieldOrPremium() public {
        ...
        uint256 expectedMintedShares = Math.mulDiv(POST_SYNC_ST_SUPPLY + VIRTUAL_SHARES, depositNAV, POST_SYNC_ST_EFF_NAV + VIRTUAL_ASSETS);
