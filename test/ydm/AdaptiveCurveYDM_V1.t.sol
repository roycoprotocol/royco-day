 ...
 */
contract AdaptiveCurveYDM_V1Test is Test {
    ...
    function test_ctor_immutables() public {
        ...
        assertEq(ydm.MAX_ADAPTATION_SPEED_WAD(), SPEED_V1, "V1 speed == 50e18/365days");
        ...
        assertEq(ydm.MAX_ADAPTATION_SPEED_WAD() * 2, ydm.MAX_ADAPTATION_SPEED_LIMIT_WAD(), "V1 speed is half the limit");
    }

    // =====================================================================
    // Group B — initializeYDMForMarket validation
    // =====================================================================
    ...
    function test_init_ytAboveWad_reverts() public {
        AdaptiveCurveYDM_V1 ydm = _deploy(5e17);
        vm.expectRevert(IYDM.INVALID_YDM_INITIALIZATION.selector);
    ...
    function test_init_flatCurve_steepnessWad() public {
        AdaptiveCurveYDM_V1 ydm = _deploy(5e17);
    ...
    function test_init_steepnessFloor() public {
        AdaptiveCurveYDM_V1 ydm = _deploy(5e17);
    ...
    function test_canonical_regionCoefficient() public {
        AdaptiveCurveYDM_V1 ydm = _canonical();
    ...
    function test_targetSweep_kinkExact() public {
    ...
    // =====================================================================
    // Group G — Long-dormancy saturation (clamp to bounds, no revert)
    // =====================================================================
    ...
    function testFuzz_firstCall_boundedAndParity(uint256 t, uint256 a, uint256 b, uint256 u) public {
    ...
    function testFuzz_anchorAtTarget(uint256 t, uint256 a, uint256 b) public {
        Cfg memory cfg = _cfg(t, a, b);
        AdaptiveCurveYDM_V1 ydm = _deploy(cfg.target);
        ydm.initializeYDMForMarket(cfg.yT, cfg.yFull);
    ...
    function testFuzz_monotonic(uint256 t, uint256 a, uint256 b, uint256 u1, uint256 u2) public {
        Cfg memory cfg = _cfg(t, a, b);
        AdaptiveCurveYDM_V1 ydm = _deploy(cfg.target);
        ydm.initializeYDMForMarket(cfg.yT, cfg.yFull);
    ...
    function testFuzz_saturation(uint256 t, uint256 a, uint256 b, uint256 uOver) public {
        Cfg memory cfg = _cfg(t, a, b);
        AdaptiveCurveYDM_V1 ydm = _deploy(cfg.target);
        ydm.initializeYDMForMarket(cfg.yT, cfg.yFull);
    ...
    function testFuzz_adaptation_matchesMirror(uint256 t, uint256 a, uint256 b, uint256 u, uint256 startRaw, uint256 dtRaw) public {
        Cfg memory cfg = _cfg(t, a, b);
        AdaptiveCurveYDM_V1 ydm = _deploy(cfg.target);
        ydm.initializeYDMForMarket(cfg.yT, cfg.yFull);
        uint256 S = _steepness(cfg.yT, cfg.yFull);
    ...
    function testFuzz_adaptationDirection(uint256 t, uint256 a, uint256 b, uint256 dtRaw) public {
        Cfg memory cfg = _cfg(t, a, b);
    ...
    function testFuzz_previewNonPersistence(uint256 t, uint256 a, uint256 b, uint256 u, uint256 dtRaw) public {
        Cfg memory cfg = _cfg(t, a, b);
        AdaptiveCurveYDM_V1 ydm = _deploy(cfg.target);
        ydm.initializeYDMForMarket(cfg.yT, cfg.yFull);
