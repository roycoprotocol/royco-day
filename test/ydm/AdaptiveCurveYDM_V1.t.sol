...
contract AdaptiveCurveYDM_V1_Test is BaseTest {
    ...
    function test_curveOutput_cappedAtWAD() public {
        ...
        uint256 yieldShare = extremeYdm.previewYieldShare(MarketState.PERPETUAL, stRawNAV, jtRawNAV, betaWAD, minCoverageWAD, jtEffectiveNAV);
    ...
    function test_steepness_flatCurve() public {
        ...
        uint256 yieldAtTarget = flatYdm.previewYieldShare(MarketState.PERPETUAL, stRawNAV1, jtRawNAV1, betaWAD1, minCoverageWAD1, jtEffectiveNAV1);
        uint256 yieldAtFull = flatYdm.previewYieldShare(MarketState.PERPETUAL, stRawNAV2, jtRawNAV2, betaWAD2, minCoverageWAD2, jtEffectiveNAV2);
    ...
    function test_steepness_steepCurve() public {
        ...
        uint256 yieldAtZero = steepYdm.previewYieldShare(MarketState.PERPETUAL, stRawNAV, jtRawNAV, betaWAD, minCoverageWAD, jtEffectiveNAV);
