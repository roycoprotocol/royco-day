...
/**
 * @title Test_OracleGuardAndConversions_LiquidityVenue
 * @notice The liquidity venue's runtime surface: the setBPTOracle pool-attestation guard, the reinvestment slippage
 ...
 */
contract Test_OracleGuardAndConversions_LiquidityVenue is DayMarketTestBase {
    ...
    function test_SetMaxReinvestmentSlippage_UpdatesStateAndEmits() public {
        ...
        assertEq(kernel.getBalancerV3LiquidityVenueState().maxReinvestmentSlippageWAD, newSlippageWAD, "the slippage bound must land in venue storage");
    }
     ...
     *         and the failed attempts leave the venue state untouched
     ...
     */
    function test_RevertIf_LiquidityVenueSettersCalledByNonAdmin() public {
...
/**
 * @title Test_SeniorShareRateProvider_LiquidityVenue
 ...
 */
contract Test_SeniorShareRateProvider_LiquidityVenue is DayMarketTestBase {
    function setUp() public virtual {
