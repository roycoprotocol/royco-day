 ...
 * @notice End-to-end pins of the mint-dilution clamp (MAX_MINT_DILUTION_WAD = WAD - 1e6, leaving pre-existing
 *         holders a 1e-12 residual) through the real tranche deposit and preview paths:
...
contract Test_MintDilutionClamp_JuniorTranche is DayMarketTestBase {
    ...
    /// @dev Virtual shares / virtual assets, restated inline (see Constants.sol VIRTUAL_SHARES / VIRTUAL_ASSETS)
