...
/// @notice Base test contract for Identical_ERC20_ST_ERC20_JT_Chainlink_Kernel
...
abstract contract YieldBearingERC20Chainlink_TestBase is AbstractKernelTestSuite {
    ...
    function _getStoredConversionRate() internal view returns (uint256) {
        return Identical_ERC20_ST_ERC20_JT_Chainlink_Kernel(address(KERNEL)).getStoredConversionRateWAD();
    }
    ...
    function _setStoredConversionRate(uint256 _newRateWAD) internal {
        ...
        Identical_ERC20_ST_ERC20_JT_Chainlink_Kernel(address(KERNEL)).setConversionRate(_newRateWAD);
    }
    ...
    function test_setTrancheAssetToReferenceAssetOracle_success() external {
        ...
        vm.prank(ORACLE_QUOTER_ADMIN_ADDRESS);
        Identical_ERC20_ST_ERC20_JT_Chainlink_Kernel(address(KERNEL)).setTrancheAssetToReferenceAssetOracle(newOracle, newStaleness);
        ...
        vm.prank(ORACLE_QUOTER_ADMIN_ADDRESS);
        Identical_ERC20_ST_ERC20_JT_Chainlink_Kernel(address(KERNEL)).setTrancheAssetToReferenceAssetOracle(anotherOracle, 3 days);
    }
    ...
    function test_setTrancheAssetToReferenceAssetOracle_revertsOnZeroAddress() external {
        ...
        Identical_ERC20_ST_ERC20_JT_Chainlink_Kernel(address(KERNEL)).setTrancheAssetToReferenceAssetOracle(address(0), 1 days);
    }
    ...
    function test_setTrancheAssetToReferenceAssetOracle_revertsOnZeroStaleness() external {
        ...
        Identical_ERC20_ST_ERC20_JT_Chainlink_Kernel(address(KERNEL)).setTrancheAssetToReferenceAssetOracle(newOracle, 0);
    }
    ...
    function test_setTrancheAssetToReferenceAssetOracle_revertsOnUnauthorized() external {
        ...
        Identical_ERC20_ST_ERC20_JT_Chainlink_Kernel(address(KERNEL)).setTrancheAssetToReferenceAssetOracle(newOracle, 1 days);
    }
    ...
    function test_oracleValidation_revertsOnStalePrice() external {
        ...
        Identical_ERC20_ST_ERC20_JT_Chainlink_Kernel(address(KERNEL)).getTrancheUnitToNAVUnitConversionRateWAD();
    }
    ...
    function test_oracleValidation_passesWithValidData() external {
        ...
        // Should not revert
        uint256 rate = Identical_ERC20_ST_ERC20_JT_Chainlink_Kernel(address(KERNEL)).getTrancheUnitToNAVUnitConversionRateWAD();
