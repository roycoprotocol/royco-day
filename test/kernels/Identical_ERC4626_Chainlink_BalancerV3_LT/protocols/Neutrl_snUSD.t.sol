...
import { BalancerLPGateReinvestForkSuite } from "../../../fork/balancer/base/BalancerLPGateReinvestForkSuite.sol";
 ...
 *         extends the abstract kernel suite) makes this one leaf carry the kernel battery plus the venue batteries.
 */
contract Neutrl_snUSD is BalancerLPGateReinvestForkSuite {
