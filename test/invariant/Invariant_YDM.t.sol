...
abstract contract BaseYDMHandler is StdUtils {
    ...
    /// @notice Anti-vacuity counters: a run that never scheduled an action is visible here
    uint256 public ghost_yieldShareCalls;
    uint256 public ghost_previewCalls;
    uint256 public ghost_warpCalls;
    uint256 public ghost_reinitCalls;
...
contract Invariant_StaticCurveYDM is StdInvariant, Test {
    ...
    /// @notice No yieldShare or previewYieldShare output ever exceeds WAD on any target, state, or utilization
    ...
    function afterInvariant() public view {
        ...
        console2.log("static yieldShare/preview/warp/reinit calls", pokes, previews, warps + reinits);
    }
}
...
contract Invariant_AdaptiveCurveYDM_V1 is StdInvariant, Test {
    ...
    /// @notice The stored adaptive yieldShareAtTargetWAD stays inside [1e14, WAD] under any warp and utilization history
    /// @dev Load-bearing because the adaptive engine feeds this value back into itself exponentially: an
    ///      escape below the floor or above WAD would compound into a zero or over-WAD premium
    ...
    function afterInvariant() public view {
        ...
        console2.log("V1 yieldShare/preview/warp/reinit calls", pokes, previews, warps + reinits);
    }
}
...
contract Invariant_AdaptiveCurveYDM_V2 is StdInvariant, Test {
