...
contract TestFuzz_RedemptionClaims_Kernel is MarketFuzzTestBase {
     ...
     * offset-aware _convertToValue (numerator gains VIRTUAL_ASSETS = 1, denominator gains VIRTUAL_SHARES = 1e6):
        ...
        public
    {
        ...
        // _convertToValue (numerator + VIRTUAL_ASSETS, denominator + VIRTUAL_SHARES), mirroring src exactly
