 ...
 */
contract AdaptiveCurveYDMFuzz is Test {
        ...
        public
    {
        ...
        RoycoTestMath.AdaptiveYdmOut memory expected = RoycoTestMath.adaptiveYdm(
            RoycoTestMath.AdaptiveYdmIn({
                utilizationWAD: u,
