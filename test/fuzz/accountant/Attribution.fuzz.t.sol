 ...
 */
contract AttributionFuzz is Test {
    ...
    function testFuzz_Attribution_flooredProRataMagnitudeWithDeltaSign(int256 _delta, uint256 _claim, uint256 _lastRaw) public view {
        ...
        assertEq(attributed, RoycoTestMath.attribute(_delta, _claim, _lastRaw), "attribution: production == independent mirror");
