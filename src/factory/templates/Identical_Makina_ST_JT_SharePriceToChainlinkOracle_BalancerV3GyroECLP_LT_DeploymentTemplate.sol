...
import { COMPONENT_ID_DAY_KERNEL_IDENTICAL_MAKINA_CHAINLINK } from "./base/Components.sol";
...
contract Identical_Makina_ST_JT_SharePriceToChainlinkOracle_BalancerV3GyroECLP_LT_DeploymentTemplate is BalancerV3_GyroECLP_LT_DeploymentTemplate {
    ...
    function _kernelComponentId() internal pure override(BalancerV3_GyroECLP_LT_DeploymentTemplate) returns (bytes32) {
        return COMPONENT_ID_DAY_KERNEL_IDENTICAL_MAKINA_CHAINLINK;
    }

    /// @inheritdoc BalancerV3_GyroECLP_LT_DeploymentTemplate
    /// @dev The Makina kernel constructor takes the machine address after the standard params
        ...
        returns (bytes memory)
    {
        ...
        return abi.encode(_cp, p.makinaMachine);
    }
