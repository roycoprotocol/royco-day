...
} from "../../kernels/Identical_ERC4626_ST_JT_SharePriceToChainlinkOracle_Day_Kernel.sol";
...
contract DayIdenticalERC4626ChainlinkDeploymentTemplate is BalancerV3DeploymentTemplate {
    ...
    {
        Identical_ERC4626_ST_JT_SharePriceToChainlinkOracle_Day_Kernel.KernelInitParams memory qp =
            abi.decode(_kernelSpecificParams, (Identical_ERC4626_ST_JT_SharePriceToChainlinkOracle_Day_Kernel.KernelInitParams));
        return abi.encodeCall(Identical_ERC4626_ST_JT_SharePriceToChainlinkOracle_Day_Kernel.initialize, (_kip, qp));
    }
}
