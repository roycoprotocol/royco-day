...
// @dev Set to 1e16 to discourage a fair share of the 18 decimals precision of the NAV units for the virtual shares
uint256 constant VIRTUAL_SHARES = 1e6;
NAV_UNIT constant VIRTUAL_ASSETS = NAV_UNIT.wrap(1);
