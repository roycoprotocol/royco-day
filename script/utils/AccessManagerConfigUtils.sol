...
abstract contract AccessManagerConfigUtils is Script {
    ...
    /**
     * @notice Writes a Safe Transaction Builder compatible JSON file
     * @param _transactions Array of transactions to include in the batch
     * @param _path Output file path (e.g., "output/config.json")
     * @param _name Name for the transaction batch (shown in Safe UI)
     */
    function writeSafeTransactionJson(SafeTransaction[] memory _transactions, string memory _path, string memory _name) internal {
        writeSafeTransactionJson(_transactions, _path, _name, "Generated by AccessManagerConfigGenerator");
    }
     ...
     */
    function writeSafeTransactionJson(SafeTransaction[] memory _transactions, string memory _path, string memory _name, string memory _description) internal {
